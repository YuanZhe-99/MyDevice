...
void main() {
  ...
  writePng(
    '/tmp/mydevice_icon_ios_default_rounded_preview.png',
    maskRoundedPreview(default1024),
  );
  writePng(
    '/tmp/mydevice_icon_ios_dark_preview.png',
    maskRoundedPreview(
      dark1024,
      backgroundR: 20,
      backgroundG: 24,
  ...
  writePng(
    '/tmp/mydevice_icon_ios_tinted_grayscale_preview.png',
    maskRoundedPreview(
      tinted1024,
      backgroundR: 32,
      backgroundG: 34,
  ...
  writePng(
    '/tmp/mydevice_icon_ios_tinted_sample_preview.png',
    maskRoundedPreview(
      tintPreview(
        tinted1024,
