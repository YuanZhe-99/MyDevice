...
- **License:** GPL-3.0.
- **Current version:** `0.5.5+18` in `pubspec.yaml`, `0.5.5.0` for MSIX, and `0.5.5` in `installer.iss`.
...
- `v0.5.5`: Services topology switches to semantic layered layout with barycenter-based column ordering, centered shared hubs, and orthogonal bundled edges so dense graphs stay readable.
